...
;
	SV *	RETVAL;
#line 10 "lib/Class/mop-class.xsi"
  {
    PERL_UNUSED_ARG(pkg);
    dKWARG(2);
    SV *superclassname = NULL;
...
;
	bool	RETVAL;
#line 91 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
    RETVAL = (meta->type == ix);
  }
#line 1632 "lib/Class/Plain.c"
	ST(0) = boolSV(RETVAL);
    }
    XSRETURN(1);
}
...
;
	SV *	RETVAL;
#line 102 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
    RETVAL = SvREFCNT_inc(meta->name);
  }
#line 1654 "lib/Class/Plain.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Class__Plain__MOP__Class_superclasses)
{
	...
	SV *	self = ST(0)
;
#line 113 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
...
XS_EUPXS(XS_Class__Plain__MOP__Class_direct_roles)
{
	...
	SV *	self = ST(0)
;
#line 132 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
    U32 count = 0;
...
;
	SV *	role = ST(1)
;
#line 170 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
...
;
	SV *	RETVAL;
#line 204 "lib/Class/mop-class.xsi"
  {
    if(items < 3)
...
;
	SV *	methodname = ST(1)
;
#line 254 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
    bool recurse = !!ix;
...
XS_EUPXS(XS_Class__Plain__MOP__Class_direct_methods)
{
	...
	SV *	self = ST(0)
;
#line 290 "lib/Class/mop-class.xsi"
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
    bool recurse = !!ix;
...
;
	SV *	mname = ST(1)
;
#line 334 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));

    mop_class_add_required_method(meta, mname);
  }
#line 1976 "lib/Class/Plain.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 345 "lib/Class/mop-class.xsi"
  {
    dKWARG(2);
...
;
	SV *	fieldname = ST(1)
;
#line 404 "lib/Class/mop-class.xsi"
  {
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
...
XS_EUPXS(XS_Class__Plain__MOP__Class_fields)
{
	...
	SV *	self = ST(0)
;
#line 430 "lib/Class/mop-class.xsi"
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
...
XS_EUPXS(XS_Class__Plain__MOP__Class_required_method_names)
{
	...
	SV *	self = ST(0)
;
#line 450 "lib/Class/mop-class.xsi"
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));
...
XS_EUPXS(XS_Class__Plain__MOP__Class_seal)
{
	...
	SV *	self = ST(0)
;
#line 470 "lib/Class/mop-class.xsi"
    ClassMeta *meta = NUM2PTR(ClassMeta *, SvUV(SvRV(self)));

    mop_class_seal(meta);
#line 2177 "lib/Class/Plain.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 10 "lib/Class/mop-method.xsi"
  {
...
;
	SV *	RETVAL;
#line 10 "lib/Class/mop-field.xsi"
  {
...
;
	SV *	obj = ST(1)
;
#line 35 "lib/Class/mop-field.xsi"
  {
    FieldMeta *meta = NUM2PTR(FieldMeta *, SvUV(SvRV(self)));
...
;
	bool	RETVAL;
#line 96 "lib/Class/mop-field.xsi"
  {
    FieldMeta *meta = NUM2PTR(FieldMeta *, SvUV(SvRV(self)));
...
;
	SV *	RETVAL;
#line 110 "lib/Class/mop-field.xsi"
  {
    FieldMeta *meta = NUM2PTR(FieldMeta *, SvUV(SvRV(self)));
...
;
	SV *	name = ST(1)
;
#line 127 "lib/Class/mop-field.xsi"
  {
    FieldMeta *meta = NUM2PTR(FieldMeta *, SvUV(SvRV(self)));
